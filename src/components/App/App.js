    ...
    return (
      <div className="App">
        ...
        <div className="footer">
          <small><a target="_black" rel="noopener noreferrer nofollow" href="https://github.com/zorbajwhk/GiveMeFood">GiveME<span role="img" aria-label="Food">🍽</span></a> v1.0.1 | Made with <span role="img" aria-label="ハート">❤️</span></small>
